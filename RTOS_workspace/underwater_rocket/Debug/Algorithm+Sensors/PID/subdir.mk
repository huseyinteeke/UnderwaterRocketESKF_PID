...
OBJS += \
./Algorithm+Sensors/PID/pid.o 

C_DEPS += \
./Algorithm+Sensors/PID/pid.d 


# Each subdirectory must supply rules for building sources it contributes
Algorithm+Sensors/PID/%.o Algorithm+Sensors/PID/%.su Algorithm+Sensors/PID/%.cyclo: ../Algorithm+Sensors/PID/%.c Algorithm+Sensors/PID/subdir.mk
...
clean: clean-Algorithm-2b-Sensors-2f-PID

clean-Algorithm-2b-Sensors-2f-PID:
	-$(RM) ./Algorithm+Sensors/PID/pid.cyclo ./Algorithm+Sensors/PID/pid.d ./Algorithm+Sensors/PID/pid.o ./Algorithm+Sensors/PID/pid.su

.PHONY: clean-Algorithm-2b-Sensors-2f-PID
