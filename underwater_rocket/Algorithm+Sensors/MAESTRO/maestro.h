...
#define SERVO_MAX_DEG	((int8_t)(65))
#define SERVO_MIN_DEG	((int8_t)(-65))
...
void Maestro_SetTarget(Maestro_Handler_t *dev , MaestroChannel_TypeDef_t channel , int8_t degrees);
